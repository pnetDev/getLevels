...
def getOid(oid):
	try:
		...
		return "NULL" ## If there is a data read error
...
## MAIN
print "-------------------------------------------------------------------------------"
modems = subprocess.check_output(['bash','get_cmtsstatustable.sh',cmts])
modems=modems.split(',')
...
for cmIP in modems:
	...
	print cmts,mac,cmIP,dsFreq,usFreq,DSP,SNR,TXP,UNR,COR,UNC,UsErrors
	firstStats.append([cmts,mac,cmIP,dsFreq,usFreq,DSP,SNR,TXP,UNR,COR,UNC,UsErrors])
...
for cmIP in modems:
        ...
        UsErrors = getUpstreamErrors(mac,cmts)
        #print mac, cmIP, "DSFREQ:", dsFreq, "USFREQ:", usFreq, "PWR:", DSP, "SNR:", SNR, "TX PWR:", TXP, "Packets:",UNR, "Corrected:", COR, "Down Uncorrected:", UNC, "Up Uncorrected:", UsErrors
        print "2nd Check",cmts,mac,cmIP,dsFreq,usFreq,DSP,SNR,TXP,UNR,COR,UNC,UsErrors
        secondStats.append([cmts,mac,cmIP,dsFreq,usFreq,DSP,SNR,TXP,UNR,COR,UNC,UsErrors])
...
for data in range(modemCount):
	...
	#print "Counter Delta"
	print cmts1,mac1,"goodWordsDelta", goodWordsDelta, "downHecWordsDelta" , downHecWordsDelta, "downHecPercent", downHecPercent, "upHecWordsDelta", upHecWordsDelta
